...
<br/><br/>
      ...
      <div class="row">
            ...
            <!-- Enter contents here -->
                    ...
                    <button type="button" class="btn btn-outline-dark btn-sm" > <strong>📃 My CV </strong></button> </a>

                    <a href="/projects">
                  <button type="button" class=" btn-outline-dark btn-sm" > <strong>👨🏻‍💻 Projects </strong></button> </a>

                    <a href="/blog">
                    <button type="button" class="btn btn-outline-dark btn-sm" > <strong>🖋️ Blog </strong></button> </a>

                    <a href="/rbi2020">
                    <button type="button" class="btn btn-outline-dark btn-sm" > <strong>🏦 Exchange Rate </strong></button> </a>
